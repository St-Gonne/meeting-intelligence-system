...
Application code and its accompanying developer docs use [PolyForm Noncommercial 1.0.0](app/LICENSE.md), following this repository's previously stated code-license direction. You can modify and share the code for permitted noncommercial purposes. This is source-available, not OSI open source. Older architecture documents retain their existing terms. The separate [phone-ingestion toolkit](https://github.com/St-Gonne/meetingintel-phone-ingest) remains Apache-2.0.
